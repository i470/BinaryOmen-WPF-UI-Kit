        ...
        private static string GetResourceDictionarySource(BaseTheme theme)
        {
            switch (theme)
            {
                case BaseTheme.Light:
                    return "pack://application:,,,/BinaryOmen.Vrika;component/Themes/BinaryOmen.Light.xaml";
                case BaseTheme.Dark:
                    return "pack://application:,,,/BinaryOmen.Vrika;component/Themes/BinaryOmen.Dark.xaml";
            }
            return null;
        }
    }
